sap.ui.define([
	...
	return BaseObject.extend("Avelon.manualnotification.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias Avelon.manualnotification.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "Instid");
			}
