sap.ui.define([
	"Avelon/manualnotification/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("Instid").length, 1, "The sorting by Instid returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by Instid and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("Instid");
