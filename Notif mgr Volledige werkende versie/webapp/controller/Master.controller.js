...
sap.ui.define([
	...
	return BaseController.extend("Avelon.manualnotification.controller.Master", {
		...
		//onSearch: function (oEvent) {
			...
			// 	if (sQuery) {
			// 		aFilter.push(new Filter("ManualNotifId", FilterOperator.Contains, sQuery));
			// 	}
			...
			var oBinding = oList.getBinding("items");
			debugger;
			this.getView().getModel().read("/NotificationInfoSet", {
			...
			// 	var filter = new sap.ui.model.Filter("ManualNotifId", sap.ui.model.FilterOperator.Contains, query);
			// 	filters.push(filter);
			// 	console.log("itworks");
			// 	console.log(query);
			// }else{
			// 	console.log("camarchepas");
			// }
		...
		// 	var laFilters = new Array();
			
		// 	var oList = this.getView().byId("list");
			
			
		// 	laFilters.push(new sap.ui.model.Filter({
		// 		path: "ManualNotifId",
		// 		operator: FilterOperator.EQ,
		...
		// 			this.getView().getModel().bindList("/NotificationInfoSet", oData.results);
